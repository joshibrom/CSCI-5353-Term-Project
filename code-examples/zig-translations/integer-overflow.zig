...
pub export fn add(arg_a: u8, arg_b: u8) u8 {
    var a = arg_a;
    _ = &a;
    var b = arg_b;
    _ = &b;
...
//    return @as(c_int, @bitCast(@as(c_uint, add(@as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 255))))), @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 70)))))))));
//}
pub export fn main() u8 {
    return add(@as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 255))))), @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 70))))));
}
